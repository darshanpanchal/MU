...
open class CircularSlider: UIControl {
     ...
     */
    @IBInspectable
    open var diskColor: UIColor = UIColor.clear
     ...
     */
    @IBInspectable
    open var endThumbTintColor: UIColor = UIColor.clear
     ...
     */
    @IBInspectable
    open var endThumbStrokeHighlightedColor: UIColor = UIColor.clear
     ...
     */
    @IBInspectable
    open var endThumbStrokeColor: UIColor = UIColor.clear
